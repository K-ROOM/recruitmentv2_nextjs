                ...
                <div className="col-span-10 ml-2">
                    <div className="grid grid-cols-12 gap-2">
                        <div className="col-span-11">
                            ...
                            <p className="text-xs font-normal text-gray-700 ml-5">บริษัทอาจเปิดเผยข้อมูลส่วนบุคคลของท่านเมื่อได้รับคำร้องขอจากท่าน ผู้สืบสิทธิ์ ทายาท ผู้แทนโดยชอบธรรม หรือผู้อนุบาลหรือผู้พิทักษ์ตามกฎหมายของท่าน โดยส่งคำร้องขอผ่าน อีเมล <a href="mailto:NECLTH-HR@nipponexpress-necl.co.th">NECLTH-HR@nipponexpress-necl.co.th</a> ในกรณีที่ท่าน ผู้สืบสิทธิ์ ทายาท ผู้แทนโดยชอบธรรม หรือผู้อนุบาลหรือผู้พิทักษ์ตามกฎหมายมีการคัดค้านการจัดเก็บ ความถูกต้อง หรือการกระทำใด ๆ เช่น การแจ้งดำเนินการปรับปรุงแก้ไขข้อมูลส่วนบุคคล บริษัทจะดำเนินการบันทึกหลักฐานคำคัดค้านดังกล่าวไว้เป็นหลักฐานด้วย ทั้งนี้ บริษัทอาจปฏิเสธสิทธิตามวรรคสองได้ในกรณีที่มีกฎหมายกำหนด หรือในกรณีที่ข้อมูลส่วนบุคคลของท่านถูกทำให้ไม่ปรากฏชื่อหรือสิ่งบอกลักษณะอันสามารถระบุตัวท่านได้</p>
                            ...
                            <p className="text-xs font-normal text-gray-700 ml-5"><b>อีเมล : </b><a href="mailto:NECLTH-HR@nipponexpress-necl.co.th">NECLTH-HR@nipponexpress-necl.co.th</a></p>
