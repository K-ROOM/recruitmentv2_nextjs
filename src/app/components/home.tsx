    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-3 sm:gap-4 px-8 pt-8 mt-8 sm:mt-8 bg-navy z-20">
                ...
                <p className="text-[13px] text-white">
                    <IoIosMail className="inline-flex w-5 h-5 text-orange-500 me-4" /><span className="font-semibold">E-mail :</span> <a href="mailto:NECLTH-HR-JOB@nipponexpress-necl.co.th" className="text-link">NECLTH-HR-JOB@nipponexpress-necl.co.th</a>
                </p>
